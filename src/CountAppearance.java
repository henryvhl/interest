...
public class CountAppearance {
    ...
    public static void main(String[] args) throws IOException {
        List<ChatRecord> records = readRecord("20161128.txt");
...
//        }
        ...
        String[] topics = {"\u4f5c\u4e1a", "\u62db\u8058", "project", 
                "\u8bfe\u7a0b", "简历", "面试", "老师", "java", "春", "冬"}; 
        
        for (int i = 0; i < topics.length; i++) {
            printTopic(records, i+1, topics[i]);
        }
//        System.out.println(String.format("\\u%04x\\u%04x", (int)'课', (int)'次'));
    ...
    private static void printTopic(List<ChatRecord> records, int index, String topic) {
        int count = 0;
